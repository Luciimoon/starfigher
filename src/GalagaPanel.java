...
public class GalagaPanel extends JPanel implements KeyListener
{
    ...
    GalagaPanel()
    {
        ...
        space = new ImageIcon("SPICYBOI.JPEG");
        shippic = new ImageIcon("Star fighter.PNG");
        dumbalien = new ImageIcon("SPOOKYBOI.PNG");
        pred = new ImageIcon("SEXOFFENDER.PNG");
        ...
        seekpic = new ImageIcon("SPOOKYBOI.PNG");
